...
pub use methods::{
    ...
    FsWriteFileArgs, GcWorktreeEntry, GcWorktreesArgs, GcWorktreesResult, GetChatBindingArgs,
    GetChatBindingResult, GetJobArgs, GetPersonaArgs, JobContextRef, JobDiffArgs, JobDiffFile,
