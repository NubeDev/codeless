#!/usr/bin/env node
// ported from moxxy-ai/moxxy crates/moxxy-runtime/sidecars/playwright/sidecar.mjs
//
// Playwright sidecar for codeless-tools.
//
// Reads line-delimited JSON-RPC requests from stdin and writes line-delimited
// JSON responses to stdout. Supervised by BrowserManager in codeless-tools.
//
